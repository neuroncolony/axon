...
window.AXON = (() => {
  const MARK = '<svg viewBox="0 0 100 100" fill="currentColor" aria-hidden="true"><ellipse cx="50" cy="19.5" rx="14.4" ry="6.6"/><ellipse cx="21.9" cy="36.2" rx="14.1" ry="6.3" transform="rotate(-59 21.9 36.2)"/><ellipse cx="78.1" cy="36.2" rx="14.1" ry="6.3" transform="rotate(59 78.1 36.2)"/><ellipse cx="21.9" cy="63.7" rx="14.1" ry="6.3" transform="rotate(59 21.9 63.7)"/><ellipse cx="78.1" cy="63.7" rx="14.1" ry="6.3" transform="rotate(-59 78.1 63.7)"/><ellipse cx="50" cy="80.2" rx="14.4" ry="6.6"/></svg>';
