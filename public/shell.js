...
window.AXON = (() => {
  const MARK = '<svg viewBox="0 0 100 100" fill="currentColor" aria-hidden="true"><ellipse cx="50" cy="9.3" rx="19.3" ry="8.9"/><ellipse cx="87.8" cy="31.8" rx="19" ry="8.6" transform="rotate(59 87.8 31.8)"/><ellipse cx="87.7" cy="68.8" rx="19" ry="8.5" transform="rotate(121 87.7 68.8)"/><ellipse cx="50" cy="90.9" rx="19.3" ry="8.7"/><ellipse cx="12.3" cy="68.8" rx="19" ry="8.5" transform="rotate(59 12.3 68.8)"/><ellipse cx="12.2" cy="31.8" rx="19" ry="8.5" transform="rotate(121 12.2 31.8)"/></svg>';
